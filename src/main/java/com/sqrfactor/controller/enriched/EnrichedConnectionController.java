...
public class EnrichedConnectionController {
	...
	public ResponseEntity<List<EnrichedConnectionWithRecent>> getConnectionsBySourceId(@PathVariable("sourceId") long sourceId) {
		...
		for(Connection connection : connections){
			...
			EnrichedConnectionWithRecent enrichedConnectionWithRecent = new EnrichedConnectionWithRecent(enrichedConnection, enrichedEducation, profession);
	...
	public ResponseEntity<List<EnrichedConnectionWithRecent>> getConnectionsByDestinationId(@PathVariable("destinationId") long destinationId) {
		List<EnrichedConnectionWithRecent> enrichedConnectionsWithRecent = new ArrayList<EnrichedConnectionWithRecent>();
	...
	private class EnrichedConnectionWithRecent{
		...
		public EnrichedConnectionWithRecent(EnrichedConnection enrichedConnection, EnrichedEducation education, Profession profession){
			super();
		...
		/**
		 * @param enrichedConnection the enrichedConnection to set
		 */
